...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'Cycle duration, periods and pregnancy'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Period alerts, fertility, messages'**
  ...
  /// No description provided for @appearanceUpdated.
  ///
  /// In en, this message translates to:
  /// **'Appearance updated'**
