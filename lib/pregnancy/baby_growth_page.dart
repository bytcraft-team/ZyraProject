...
class _BabyGrowthContentState extends State<BabyGrowthContent> {
  ...
  static const int _currentWeek = 19;

  @override
  void initState() {
    super.initState();
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final offset = (_currentWeek - 1) * 76.0 - 40;
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildDivider(),
                  const SizedBox(height: 24),
                  _buildPregnancyInfoCards(context),
                  const SizedBox(height: 24),
                  _buildDivider(),
                  const SizedBox(height: 24),
    ...
    return Column(
      children: [
        ...
        Row(
          ...
          children: [
            Flexible(child: _inlineStat('193 g', 'Poids')),
            const SizedBox(width: 8),
            Flexible(child: _inlineStat('15.3 cm', 'Taille')),
            const SizedBox(width: 8),
  ...
  Widget _buildProgressSection() {
    const double progress = _currentWeek / 40;
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        ...
        Row(
          children: [
            ...
            Expanded(
              child: Column(
                children: [
                  _progressRow('Restant', '21 semaines'),
                  const SizedBox(height: 8),
                  _progressRow('Avancement', '47%'),
        ...
        SizedBox(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              final week = index + 1;
              final isActive = week == (_selectedWeek ?? _currentWeek);
  ...
  // GUIDE ROWS
  // ─────────────────────────────────────────────
  Widget _buildPregnancyInfoCards(BuildContext context) {
    final cards = [
      {
        'title': 'Maman',
        'week': 'Semaine 1',
