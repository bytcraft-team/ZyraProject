...
class _SymptomTrackingPageState extends State<SymptomTrackingPage>
  ...
  static const _moods = [
    _MoodData(Icons.sentiment_very_dissatisfied_rounded, 'Difficile', Color(0xFFCF8080)),
    _MoodData(Icons.sentiment_dissatisfied_rounded,      'Fatigué',   Color(0xFFCFAF80)),
    ...
    _MoodData(Icons.sentiment_very_satisfied_rounded,    'Radieuse',  Color(0xFF80CFAA)),
  ];

  // ── Symptoms
  final List<_SymptomData> _symptoms = [
    _SymptomData(
      id: 'nausea',    label: 'Nausées',          sublabel: 'Inconfort digestif',
      icon: Icons.sick_rounded,
      accent: _C.sNausea, bg: _C.bNausea,
    ),
    _SymptomData(
      id: 'fatigue',   label: 'Fatigue',           sublabel: 'Manque d\'énergie',
      icon: Icons.battery_3_bar_rounded,
      accent: _C.sFatigue, bg: _C.bFatigue,
    ),
    _SymptomData(
      id: 'headache',  label: 'Maux de tête',      sublabel: 'Céphalées, migraines',
      icon: Icons.psychology_rounded,
      accent: _C.sHeadache, bg: _C.bHeadache,
    ),
    _SymptomData(
      id: 'back',      label: 'Douleurs dos',      sublabel: 'Lombaires, tensions',
      icon: Icons.accessibility_new_rounded,
      accent: _C.sBack, bg: _C.bBack,
    ),
    _SymptomData(
      id: 'cramps',    label: 'Crampes',            sublabel: 'Contractions légères',
      icon: Icons.electric_bolt_rounded,
      accent: _C.sCramps, bg: _C.bCramps,
    ),
    _SymptomData(
      id: 'mood',      label: 'Humeur',             sublabel: 'Émotions, irritabilité',
      icon: Icons.mood_rounded,
      accent: _C.sMood, bg: _C.bMood,
    ),
    _SymptomData(
      id: 'sleep',     label: 'Sommeil',            sublabel: 'Qualité du repos',
      icon: Icons.bedtime_rounded,
      accent: _C.sSleep, bg: _C.bSleep,
    ),
    _SymptomData(
      id: 'appetite',  label: 'Appétit',            sublabel: 'Envies, fringales',
      icon: Icons.restaurant_rounded,
      accent: _C.sAppetite, bg: _C.bAppetite,
    ),
    _SymptomData(
      id: 'movements', label: 'Mouvements bébé',   sublabel: 'Coups, activité',
      icon: Icons.child_friendly_rounded,
      accent: _C.sMovements, bg: _C.bMovements,
    ),
  ];
        ...
        content: Row(
          children: [
            Container(
              ...
              child: const Icon(Icons.check_rounded, color: _C.primary, size: 20),
            ),
