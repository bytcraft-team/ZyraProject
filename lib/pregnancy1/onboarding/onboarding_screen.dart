...
import 'package:zyra/pregnancy1/onboarding/onboarding_model.dart';
import 'package:zyra/pregnancy1/onboarding/onboarding_service.dart';
...
import 'package:zyra/pregnancy1/services/pregnancy_calculator.dart';
import 'package:zyra/cycle1/views/onboarding/onboarding_screen.dart';
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            style: theme.textTheme.bodyMedium?.copyWith(
                              color: _titleColor.withValues(alpha: 0.7),
                              height: 1.5,
                            ),
                          ),
...
class _PregnancyOnboardingFlowState extends State<PregnancyOnboardingFlow> {
  ...
  final bool _nutritionTips = true;
  ...
  Future<void> _finish() async {
    ...
    // Calcule les données de suivi de grossesse sur la base de la date LMP
    ...
    // Crée les données d'onboarding avec semaine calculée par LMP
    final data = OnboardingData(
      profileType: UserProfileType.pregnancy,
      pregnancyWeek: adjustedWeek,
                              ...
                              children: [
                                ...
                                Card(
                                  ...
                                  shape: RoundedRectangleBorder(
                                    ...
                                    side: BorderSide(
                                      color: _subColor.withValues(alpha: 0.25),
                                    ),
                                  ),
                                  elevation: 0,
                                  child: Padding(
        ...
        return InkWell(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(20),
              border: Border.all(color: _subColor.withValues(alpha: 0.35)),
            ),
            child: Row(
              children: [
                ShaderMask(
                            ...
                            style: Theme.of(context).textTheme.bodyMedium
                                ?.copyWith(
                                  color: sel
                                      ...
                                      : _labelColor.withValues(alpha: 0.75),
                                ),
                          ),
                        ],
                      ),
